...
function capno_scal
    ...
    %--------------------------------
    y=load('/Users/sharscoat/Documents/SHARSCOAT/Master_IRIV/Capnographie/wave_form/WaveForm_NORMAL_25.txt'); 
    %--------------------------------
    % COURBE
    ...
    ylabel('k (echelle)');
    subplot(2,3,(4:5));
    hold on; plot(courbe,'r.-'); plot(y,'ob'); 
    ...
    text(0.9, 1.00, ['N0 = ' num2str(N0,'%5.0f \t')], 'FontSize', 14, 'FontWeight', 'bold');
    text(0., 0.85, ['T1 = ' num2str(T1,'%5.1f \t')], 'FontSize', 14, 'FontWeight', 'bold'); 
    text(0.3, 0.85, ['T2 = ' num2str(T2,'%5.1f \t')], 'FontSize', 14);
    text(0.6, 0.85, ['t2 = ' num2str(t2,'%5.0f \t')], 'FontSize', 14);
    text(0.9, 0.85, ['n = ' num2str(n,'%5.0f \t')], 'FontSize', 14);
   ...
   % Create slider : "a"
    ...
    sld = uicontrol('Style', 'slider',...
        ...
        'Position', [850 20 120 20],...
        'Callback', @lim_t2); 
					
    % Add a text uicontrol to label the slider.
    txt = uicontrol('Style','text',...
        'Position',[850 40 120 20],...
        'String','variable "t2"');
    
    % Create slider : "t0"
    sld = uicontrol('Style', 'slider',...
        'Min',0,'Max',100,'Value',10,...
        'Position', [1000 20 120 20],...
        'Callback', @lim_t0); 
					
    % Add a text uicontrol to label the slider.
    txt = uicontrol('Style','text',...
        'Position',[1000 40 120 20],...
        'String','variable "t0"');
