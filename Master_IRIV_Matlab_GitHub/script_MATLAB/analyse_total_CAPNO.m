...
%%%%%%%%%%%      analyse sur la totalité de la courbe         %%%%%%%%%%%%%
...
newmap = 'jet';
subplot(3,1,(1:2));
imagesc(resultat,[-5 5]); caxis([0,0.05]); colorbar; colormap(newmap); %
xlabel('n (temps)'); 
ylabel('k (echelle)');
subplot(3,1,3);
plot(y,'r.-');
...
newmap = 'jet';
subplot(3,1,(1:2));
imagesc(resultat,[-5 5]); caxis([-0.1,0]); colorbar; colormap(newmap); %
xlabel('n (temps)'); 
ylabel('k (echelle)');
subplot(3,1,3);
plot(y,'r.-');
...
file_dossier='/Users/sharscoat/Documents/SHARSCOAT/Master_IRIV/Capnographie/essaie/010581.txt'
